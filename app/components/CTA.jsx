...
const CTA = () => {
  return (
    <section className="py-12 px-4 sm:px-6">
      ...
      <p className="text-gray-600 text-center max-w-3xl mx-auto mb-10 text-base sm:text-lg">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a metus
        vel sapien bibendum convallis in non quam.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-6xl mx-auto">
        ...
        <Link href="/courses/jee">
          <div className="cursor-pointer bg-gray-50 p-4 rounded-xl shadow-md hover:shadow-lg transition flex items-center justify-between h-48">
            <div className="flex flex-col justify-between h-full">
              <h3 className="text-xl sm:text-2xl font-semibold text-gray-800">JEE</h3>
        ...
        <Link href="/courses/neet">
          <div className="cursor-pointer bg-gray-50 p-4 rounded-xl shadow-md hover:shadow-lg transition flex items-center justify-between h-48">
            <div className="flex flex-col justify-between h-full">
              <h3 className="text-xl sm:text-2xl font-semibold text-gray-800">NEET</h3>
              <p className="text-sm text-gray-600 mt-2">
        ...
        <Link href="/courses/eapcet">
          <div className="cursor-pointer bg-gray-50 p-4 rounded-xl shadow-md hover:shadow-lg transition flex items-center justify-between h-48">
            <div className="flex flex-col justify-between h-full">
              <h3 className="text-xl sm:text-2xl font-semibold text-gray-800">EAPCET</h3>
              <p className="text-sm text-gray-600 mt-2">
